...
protected:
  /** Constructor. */
  Create_func_arg2_or_3() {}
  /** Destructor. */
  virtual ~Create_func_arg2_or_3() {}
};
...
class Create_func_distance_sphere: public Create_func_arg2_or_3
{
  public:
    virtual Item* create_2_arg(THD *thd, Item *arg1, Item *arg2);
    virtual Item* create_3_arg(THD *thd, Item *arg1, Item *arg2, Item *arg3);
...
Item*
Create_func_arg2_or_3::create_func(THD *thd, LEX_STRING name,
                                   List<Item> *item_list)
{
  int arg_count= 0;
...
Item*
Create_func_distance_sphere::create_2_arg(THD *thd, Item *arg1, Item *arg2)
{
  return new (thd->mem_root) Item_func_sphere_distance(thd, arg1, arg2);
}

Item*
Create_func_distance_sphere::create_3_arg(THD *thd, Item *arg1, Item *arg2,
                                          Item *arg3)
{
  return new (thd->mem_root) Item_func_sphere_distance(thd, arg1, arg2, arg3);
}
#endif
